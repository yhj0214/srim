...
@Component
public class AkHoldingsNetIncomeAttributionFallbackRule implements XbrlNetIncomeAttributionFallbackRule {
    ...
    @Override
    public Optional<XbrlNetIncomeAttributionFallbackResolver.ResolvedNetIncomeAttribution> resolve(
        ...
        for (XbrlFactView ownerCandidate : customProfitLossFacts) {
            ...
            for (XbrlFactView noncontCandidate : customProfitLossFacts) {
                ...
                return Optional.of(new XbrlNetIncomeAttributionFallbackResolver.ResolvedNetIncomeAttribution(
                        ownerCandidate,
                        noncontCandidate
                ));
            }
